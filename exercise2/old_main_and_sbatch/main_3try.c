...
int main(int argc, char *argv[]) {
    ...
    int *data= NULL;
    FILE *fp;
    char filename[] = "results_pow6.csv";
    long long int size;
    MPI_Init(&argc, &argv);
        int warmup_value =  0;
    ...
    fprintf(fp, "code with barrrier, removed barrier at the and of chain. Barrrier only before the call of chain or bin tree\n");
    ...
    for (int pow =  1; pow <=  20; ++pow) {
        ...
        fprintf(fp, "%d,%f,%f\n", size, avg_time_bintree*1000, avg_time_chai*1000);
    }
