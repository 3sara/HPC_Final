...
int main(int argc, char *argv[]) {
    ...
    fprintf(fp, "code with barrrier, removed barrier at the and of chain. Barrrier only before the call of chain or bin tree, MPI reduce to write\n");
