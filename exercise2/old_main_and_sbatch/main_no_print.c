...
int main(int argc, char *argv[]) {
	...
	double elapsed_time_chain=end_time_chain - start_time_chain;
        printf("Time taken by process bintree: %.3f microseconds\n", (end_time_bintree-start_time_bintree) * 1000000);
	printf("Time taken by process chain: %.3f microseconds\n", (end_time_chain - start_time_chain) * 1000000);
    }
