...
#define NUM_RUNS 5 // Numero di esecuzioni per ogni dimensione dei dati
#define MIN_SIZE 1000 // Dimensione minima dei dati
#define MAX_SIZE 1000000 // Dimensione massima dei dati
#define STEP_SIZE 1000 // Incremento della dimensione dei dati
